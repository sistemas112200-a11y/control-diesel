  ...
  return (
    <header className="h-14 border-b border-slate-200 bg-white flex items-center justify-between px-6 print:hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-8 h-8 rounded-full bg-blue-100 text-blue-700 text-xs font-medium flex items-center justify-center">{iniciales}</div>
        ...
        <form action={logoutAction}>
          <button type="submit" title="Cerrar sesión" className="ml-2 flex items-center gap-1 rounded-md p-2 text-slate-400 hover:bg-red-50 hover:text-red-600 transition-colors">
