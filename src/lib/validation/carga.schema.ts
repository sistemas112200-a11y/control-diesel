...
export const cargaSchema = z.object({
  ...
  foto_ticket_url: z.string().url('Falta la foto del ticket'),
  foto_kilometraje_url: z.string().url('Falta la foto del kilometraje'),
  foto_bomba_url: z.string().url('Falta la foto de la bomba'),
  foto_tanque1_url: z.string().url('Falta la foto del tanque 1'),
