...
import { crearUsuarioEmpresaAction } from './actions'

export default async function NuevoUsuarioEmpresaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-xl space-y-6">
      <h1 className="text-lg font-semibold text-slate-900">Nuevo usuario — {empresa.nombre}</h1>

      <form action={crearUsuarioEmpresaAction} className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
